...
EXPERIMENT_NAMES.update({
    "FEDAVG_STRICT": "Strict Federated FedAvg",
    "FEDYOGI_STRICT": "Strict Federated FedYogi",
    "DPCV_FEDYOGI": "Deterministic Proposal-Critique-Vote FedYogi",
    "SA_PCV_FEDYOGI": "Single-Agent Proposal-Critique-Vote FedYogi",
    "FMAS_PCV_FEDYOGI": "Federated Multi-Agent Proposal-Critique-Vote FedYogi",
})

FORMAL_EXPERIMENT_ORDER = list(FORMAL_METHOD_ORDER)
